return function()
  ...
  map("n", "<leader>gm", function() require("telescope.builtin").git_bcommits() end, {
    desc = "Git Commits for current buffer",
  })
  -- --

  map("n", "<leader>mm", function() require("telescope.builtin").keymaps() end, {
    desc = "Show keymaps",
  })

  map("n", "ma", function() require("telescope").extensions.vim_bookmarks.all() end, {
    desc = "Show Bookmarks",
  })
  ...
  map("n", "<leader>s", function() require("telescope.builtin").grep_string() end, {
    desc = "Telescope search current word",
  })

  map("n", "<leader>r", function() require("telescope").extensions.live_grep_args.live_grep_args() end, {
  ...
  map("n", "<leader>]", function() require("telescope.builtin").diagnostics() end, {
    desc = "Find All Diagnostics",
  })

  map("n", "<leader>q", function() require("telescope.builtin").quickfix() end, {
    desc = "Quick fix",
  })

  map("n", "<leader>e", function() require("telescope.builtin").lsp_document_symbols() end, {
    desc = "Document Symbols",
  })

  -- Comment
  if utils.is_available "Comment.nvim" then
    map("n", "<leader><Space>", function() require("Comment.api").toggle.linewise.current() end, {
      desc = "Comment line",
    })
